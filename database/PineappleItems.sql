CREATE DATABASE IF NOT EXISTS PineappleItems CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS pinebook_image_path (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    image_path VARCHAR(255) NOT NULL
);

INSERT INTO pinebook_image_path (name, image_path) VALUES
('PineBook King', '/pineApple/image/PineBook/PineBook King - 1.png'),
('PineBook King', '/pineApple/image/PineBook/PineBook King - 2.png'),
('PineBook Light', '/pineApple/image/PineBook/PineBook Light - 1.png'),
('PineBook Light', '/pineApple/image/PineBook/PineBook Light - 2.png'),
('PineBook Light', '/pineApple/image/PineBook/PineBook Light - 3.png'),
('PineBook Light', '/pineApple/image/PineBook/PineBook Light - 4.png');
...
CREATE TABLE IF NOT EXISTS pinephone_image_path (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    image_path VARCHAR(255) NOT NULL
);

INSERT INTO pinephone_image_path (name, image_path) VALUES
('PinePhone Cutie', '/pineApple/image/PinePhone/PinePhone Cutie - 1.png'),
('PinePhone Cutie', '/pineApple/image/PinePhone/PinePhone Cutie - 2.png'),
('PinePhone Cutie', '/pineApple/image/PinePhone/PinePhone Cutie - 3.png'),
('PinePhone Cutie', '/pineApple/image/PinePhone/PinePhone Cutie - 4.png'),
('PinePhone OG','/pineApple/image/PinePhone/PinePhone OG - 1.png'),
('PinePhone OG','/pineApple/image/PinePhone/PinePhone OG - 2.png'),
('PinePhone OG','/pineApple/image/PinePhone/PinePhone OG - 3.png'),
('PinePhone OG','/pineApple/image/PinePhone/PinePhone OG - 4.png'),
('PinePhone Primitive', '/pineApple/image/PinePhone/PinePhone Primitive - 1.png'),
('PinePhone Primitive', '/pineApple/image/PinePhone/PinePhone Primitive - 2.png'),
('PinePhone Primitive', '/pineApple/image/PinePhone/PinePhone Primitive - 3.png'),
('PinePhone Primitive', '/pineApple/image/PinePhone/PinePhone Primitive - 4.png'),
('PinePhone Pro Gamer', '/pineApple/image/PinePhone/PinePhone Pro Gamer - 1.png'),
('PinePhone Pro Gamer', '/pineApple/image/PinePhone/PinePhone Pro Gamer - 2.png'),
('PinePhone Pro Gamer', '/pineApple/image/PinePhone/PinePhone Pro Gamer - 3.png'),
('PinePhone Pro Gamer', '/pineApple/image/PinePhone/PinePhone Pro Gamer - 4.png'),
('PinePhone Pro Ultimate', '/pineApple/image/PinePhone/PinePhone Pro Ultimate - 1.png'),
('PinePhone Pro Ultimate', '/pineApple/image/PinePhone/PinePhone Pro Ultimate - 2.png'),
('PinePhone Pro Ultimate', '/pineApple/image/PinePhone/PinePhone Pro Ultimate - 3.png'),
('PinePhone Pro Ultimate', '/pineApple/image/PinePhone/PinePhone Pro Ultimate - 4.png');
...
CREATE TABLE IF NOT EXISTS pinepad_image_path (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    image_path VARCHAR(255) NOT NULL
);

INSERT INTO pinepad_image_path (name, image_path) VALUES
('PinePad Gamer', '/pineApple/image/PinePad/PinePad Gamer - 1.png'),
('PinePad Gamer', '/pineApple/image/PinePad/PinePad Gamer - 2.png'),
('PinePad Gamer', '/pineApple/image/PinePad/PinePad Gamer - 3.png'),
('PinePad Gamer', '/pineApple/image/PinePad/PinePad Gamer - 4.png'),
('PinePad OG', '/pineApple/image/PinePad/PinePad OG - 1.png'),
('PinePad OG', '/pineApple/image/PinePad/PinePad OG - 2.png'),
('PinePad OG', '/pineApple/image/PinePad/PinePad OG - 3.png'),
('PinePad Pro', '/pineApple/image/PinePad/PinePad Pro - 1.png'),
('PinePad Pro', '/pineApple/image/PinePad/PinePad Pro - 3.png'),
('PinePad Pro', '/pineApple/image/PinePad/PinePad Pro - 4.png'),
('PinePad Pro', '/pineApple/image/PinePad/PinePad Pro - 6.png'),
('PinePad Smol', '/pineApple/image/PinePad/PinePad Smol - 1.png'),
('PinePad Smol', '/pineApple/image/PinePad/PinePad Smol - 2.png'),
('PinePad Smol', '/pineApple/image/PinePad/PinePad Smol - 3.png');
...
CREATE TABLE IF NOT EXISTS pinepods_image_path (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    image_path VARCHAR(255) NOT NULL
);

INSERT INTO pinepods_image_path (name, image_path) VALUES
('PinePods Gen X', '/pineApple/image/PinePods/PinePods Gen X - 1.png'),
('PinePods Gen X', '/pineApple/image/PinePods/PinePods Gen X - 2.png'),
('PinePods Gen X', '/pineApple/image/PinePods/PinePods Gen X - 3.png'),
('PinePods Gen Y', '/pineApple/image/PinePods/PinePods Gen Y - 1.png'),
('PinePods Gen Y', '/pineApple/image/PinePods/PinePods Gen Y - 2.png'),
('PinePods Gen Y', '/pineApple/image/PinePods/PinePods Gen Y - 3.png'),
('PinePods Gen Z', '/pineApple/image/PinePods/PinePods Gen Z - 1.png'),
('PinePods Gen Z', '/pineApple/image/PinePods/PinePods Gen Z - 2.png'),
('PinePods Gen Z', '/pineApple/image/PinePods/PinePods Gen Z - 3.png'),
('PinePods Gen Z', '/pineApple/image/PinePods/PinePods Gen Z - 4.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 1.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 2.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 3.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 4.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 5.png'),
('PinePods Ultimate', '/pineApple/image/PinePods/PinePods Ultimate - 6.png');

CREATE TABLE IF NOT EXISTS PineapplePencil (
    id INT(11) AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(30),
    description VARCHAR(255),
    price DECIMAL(6,2)
...
INSERT INTO PineapplePencil (name, description, price) VALUES
...
CREATE TABLE IF NOT EXISTS pineapplepencil_image_path (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    image_path VARCHAR(255) NOT NULL
);

INSERT INTO pineapplepencil_image_path (name, image_path) VALUES
('Pineapple Pencil OG', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil OG - 1.png'),
('Pineapple Pencil OG', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil OG - 2.png'),
('Pineapple Pencil Gen 2', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Gen 2 - 1.png'),
('Pineapple Pencil Gen 2', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Gen 2 - 2.png'),
('Pineapple Pencil Gen 3', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Gen 3 - 1.png'),
('Pineapple Pencil Gen 3', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Gen 3 - 2.png'),
('Pineapple Pencil Pro', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Pro - 1.png'),
('Pineapple Pencil Pro', '/pineApple/image/Accessories/Pineapple Pencil/ Pineapple Pencil Pro - 2.png');