...
<body>
    ...
    <div class="edit-profile-container">
        ...
        <form id="editProfileForm" action="database/EditProfileValidation.php" method="post"
            enctype="multipart/form-data">
            <!-- Profile Picture -->
            <div class="profile-pic">
                <img src="/pineApple/image/<?php echo htmlspecialchars($profilePic); ?>" alt="Profile Picture"
                    id="profilePic">
            ...
            <div class="input-group">
                ...
                <input type="text" id="PineAppleID" name="PineAppleID"
                    value="<?php echo htmlspecialchars($pineapple_id); ?>" readonly>
            </div>
            ...
            <div class="input-group">
                ...
                <input type="email" id="new-email" name="email" value="<?php echo htmlspecialchars($email); ?>"
                    required>
